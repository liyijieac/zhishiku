								...
								<div id="login-box" class="login-box widget-box no-border visible">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="login_icon"><img src="image/login.png" /></div>



			<form action="{{ route('doadmin_login') }}" method="post">
			{{csrf_field()}}
				<fieldset>
				<ul>
   					...
   					<li class="frame_style form_error">
	   					...
	   					<input name="admin_name" type="text"  id="username"/><i>用户名</i>
					</li>


   					<li class="frame_style form_error">
	   					<label class="password_icon"></label>
	   					<input name="admin_password" type="password"  id="userpwd"/><i>密码</i>
					</li>
