 ...
 <div class="search_style">
	...
	<tbody>
     ...
     <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
          <td>{{ $t->id }}</td>
          <td><u style="cursor:pointer"  class="text-primary" >{{ $t->user_id }}</u></td>
          <td class="text-l">
          <a href="javascript:;">{{ $t->you_want }}</a>
		  <td>{{ $t->you_theme }}</td>
		  <td>{{ $t->you_email }}</td>
          <td>{{ $t->created_at }}</td>
        ...
        <a  href="{{ route('admin_gues_delete' , ['id' => $t->id ]) }}" title="删除" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
          </td>
        </tr>
