                                ...
                                <div class="row">
                                        ...
                                        <div class="span8 page-content">
                                                ...
                                                <article class="type-page hentry clearfix">
                                                        ...
                                                        <hr>
                                                        <p>如果你有一切有关于技术或者生活上的问题欢迎留下你们的联系方式，并且给你答复.</p>
                                                </article>
                                                ...
                                                {{ csrf_field() }}
                                                        ...
                                                        <div class="span2">
                                                                <label for="email">你的邮箱 <span>*</span></label>
                                                        </div>
                                                        <div class="span6">
                                                                <input type="text" name="you_email" id="email" class="email required input-xlarge" value="" title="* Please provide a valid email address">
                                                        </div>
                                                        ...
                                                        <div class="span6">
                                                                <input type="text" name="you_theme" id="reason" class="input-xlarge" value="">
                                                        </div>

                                                        <div class="span2">
                                                                <label for="message">你想说什么 <span>*</span> </label>
                                                        </div>
                                                        <div class="span6">
                                                                <textarea name="you_want" id="message" class="required span6" rows="6" title="* Please enter your message"></textarea>
                                                        </div>

                                                        <div class="span6 offset2 bm30">
                                                                <input type="submit" name="submit" value="快点我" class="btn btn-inverse">
